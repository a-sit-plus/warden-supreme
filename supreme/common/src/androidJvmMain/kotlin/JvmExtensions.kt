...
@Deprecated("To be Removed in Warden Supreme 1.2; Unsafe behaviour", replaceWith = ReplaceWith("closestToRoot { it.hasAndroidKeyAttestationExtensionOid }.androidAttestationExtension"), DeprecationLevel.ERROR)

...
## Android Attestation
- <a id="ref-android-key-attestation"></a>Android Key Attestation — Developer Guide: [Docs]({{ links.android_key_attestation }})
- <a id="ref-android-key-id-attestation"></a>Android Key and ID Attestation — AOSP Spec and Schema: [Docs]({{ links.android_key_id_attestation }})
- <a id="ref-android-rkp"></a><a id="ref-android-rkpd"></a>Remote Key Provisioning — AOSP Source: [Source]({{ links.android_rkp_source }})
- <a id="ref-android-rkp-overview"></a>Remote Key Provisioning — AOSP Docs: [Docs]({{ links.android_rkp_docs }})
...
- <a id="ref-android-keystore2-fix"></a>Android Keystore2 Stability Fix — Post‑Android 16: [Source]({{ links.android_keystore2_binder_fix }})
- <a id="ref-android-attestation-lib-legacy"></a>Android Attestation Libraries — Legacy: GitHub Repo: [google/android-key-attestation]({{ links.github_google_android_key_attestation }})
- <a id="ref-android-attestation-lib-current"></a>Android Attestation Libraries — Current: GitHub Repo: [android/keyattestation]({{ links.github_android_keyattestation }})
- <a id="ref-android-security-bulletin"></a>Android Security Bulletin — Vulnerability Advisories: [Website]({{ links.android_security_bulletin }})

## iOS App Attest
- <a id="ref-ios-devicecheck-overview"></a>Apple Device Integrity Overview — DeviceCheck / App Attest: [Docs]({{ links.ios_devicecheck }})
- <a id="ref-ios-validating-apps"></a>Apple Server Validation Guide — DeviceCheck / App Attest: [Docs]({{ links.ios_validating_apps }})
- <a id="ref-ios-attestation-validation"></a>Apple Attestation Object Validation — App Attest Format: [Docs]({{ links.ios_attestation_validation }})
- <a id="ref-ios-app-attest-setup"></a>Apple App Attest Setup and Requirements: [Docs]({{ links.ios_preparing_app_attest }})
- <a id="ref-ios-fraud-risk"></a>Apple Fraud Risk Assessment — App Attest Receipt: [Docs]({{ links.ios_assessing_fraud_risk }})
- <a id="ref-ios-secure-enclave"></a>Apple Secure Enclave: [Docs]({{ links.ios_secure_enclave }})
...
- <a id="ref-sybil-attack"></a>The Sybil Attack — Foundational Concept for Identity Fraud: [Paper (PDF)]({{ links.sybil_attack_paper_pdf }})
- <a id="ref-cbor"></a>CBOR (IETF): [RFC 7049]({{ links.rfc_7049_cbor }})
- <a id="ref-cose"></a>COSE (IETF): [RFC 8152]({{ links.rfc_8152_cose }})

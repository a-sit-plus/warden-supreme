...
object SoftwareAttestationVerifier{
    ...
    @JvmOverloads
    @Deprecated("To be removed in 1.1", replaceWith = ReplaceWith("Roboto"))
     operator fun invoke( attestationConfiguration: AndroidAttestationConfiguration,
                          verifyChallenge: (expected: ByteArray, actual: ByteArray) -> Boolean = { expected, actual -> expected contentEquals actual }): Roboto {

...
fun Application.configureSecurity() {
    ...
    val caCert = CA_CERT
    authentication {
        this.bearer("jwt") { //we are doing custom JWT auth for demonstration purposes
            ...
            authenticate { tokenCredential ->
                runCatching {
                    ...
                    SignedJWT.parse(tokenCredential.token)?.let { jwt ->
                        ...
                        caCert.verifyJWTAndExtractSignerSubject(jwt, offset, logger)?.let { (name, nonce) ->
...
private suspend fun at.asitplus.signum.indispensable.pki.X509Certificate.verifyJWTAndExtractSignerSubject(
    ...
    offset: Duration,
    logger: Logger
): Pair<String, String?>? = catchingUnwrapped {
